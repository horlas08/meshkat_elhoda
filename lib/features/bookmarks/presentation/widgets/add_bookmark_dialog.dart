      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context)!.addBookmarkTitle,
              style: TextStyle(
                fontSize: 20.sp,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h),
                  Text(
                    '${AppLocalizations.of(context)!.verse} ${widget.ayahNumber}',
            ...
            if (_addNote) ...[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppLocalizations.of(context)!.writeNoteHere,
                  hintStyle: TextStyle(
                    fontSize: 14.sp,
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      final note = _addNote && _noteController.text.isNotEmpty
