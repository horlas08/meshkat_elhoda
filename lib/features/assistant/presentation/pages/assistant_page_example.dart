        ...
        builder: (context, state) {
          ...
          return Column(
            children: [
              ...
              // ⚠️ رسالة تحذيرية عن الذكاء الاصطناعي
              Container(
        ...
        if (!featureManager.canUseAIUnlimited) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: Text(
                AppLocalizations.of(context)!.featureAvailableForPremium,
              ),
              content: Text(
                AppLocalizations.of(context)!.premiumFeatureContent,
              ),
              actions: [
                TextButton(
          ...
          content: Column(
            ...
            children: [
              RadioListTile<String>(
                title: Text(AppLocalizations.of(context)!.gpt4oMiniTitle),
