...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get onboardingDescription1 => 'Kuran, Zikirler ve Hadisleri tek bir yerde toplayan bir uygulama ile manevi yolculuğunuza başlayın.';

  @override
  String get onboardingDescription2 => '50\\\'den fazla okuyucudan tilavetleri dinleyin ve son okuma konumunuzu kolayca kaydedin.';

  @override
  String get onboardingDescription3 => 'Günlük zikirler ve hayatınız için kategorize edilmiş dualarla her an size Allah\\\'ı hatırlatır.';

  @override
  String get onboardingDescription4 => 'Mekke ve Medine\\\'den doğrudan manevi atmosferi istediğiniz zaman ve yerde yaşayın.';
  ...
  @override
  String get locationPermissionDescription => 'Doğru namaz vakitlerini göstermek için konumunuza ihtiyacımız var. Şunları yapabilirsiniz:';
  ...
  @override
  String get deleteBookmarkContent => 'Bu yer imini silmek istediğinizden emin misiniz?';
  ...
  @override
  String get adhanStopHint => 'Ezanı durdurmak için buraya dokunun';
  ...
  @override
  String get licensed_broadcast => 'Bu yayın resmi Suudi kanallarından lisanslıdır';
  ...
  String hadithLoadError(String error) {
    return 'Hadis yüklenemedi: $error';
  }
  ...
  @override
  String get zakatDisclaimer => 'Not: Bu hesaplama yaklaşıktır ve dini bir fetva değildir.\\nDoğru dini karar için lütfen bilgili alimlere danışın.';
  ...
  @override
  String get requiredForNisaab => 'Nisab hesaplaması için gereklidir (85 gram altın)';

  @override
  String get requiredForGoldValue => 'Gramdan altın değerini hesaplamak için gereklidir';
  ...
  @override
  String get connectedNow => 'Şu anda bağlı';

  @override
  String get haramAndLive => 'Haram & Canlı Yayın';

  @override
  String get khatmahList => 'Hatimler';

  @override
  String get licensedMessage => 'Bu yayın resmi Suudi kanallarından lisanslıdır';

  @override
  String get newKhatmah => 'Yeni Hatim';

  @override
  String get setQibla => 'Kıbleyi ayarla';

  @override
  String get startQuranJourney => 'Kuran yolculuğuna başla';

  @override
  String get yourCurrentKhatmah => 'Mevcut Hatminiz';
  ...
  @override
  String get startNewChatMessage => 'Bir mesaj göndererek yeni bir konuşma başlatın';
  ...
  String dailyLimitReachedMessage(Object dailyCount, Object maxQuestions) {
    return 'Bugün $maxQuestions sorudan $dailyCount tanesini kullandınız';
  }
  ...
  @override
  String get premiumFeatureTitle => 'AI model seçimi sadece premium aboneler için kullanılabilir';

  @override
  String get premiumFeatureContent => 'Yükselterek elde edin:\\n• Gelişmiş model seçimi\\n• Sınırsız soru\\n• Daha detaylı cevaplar';
  ...
  @override
  String get noConversationsMessage => 'Henüz konuşma yok. Yeni oluşturmak için +\\\'ya tıklayın';
  ...
  @override
  String get aiGeneratedAnswersNeedReview => 'Yapay zeka tarafından oluşturulan cevapların gözden geçirilmesi gerekir';
  ...
  @override
  String get areYouSureDelete => 'Bu yer imini silmek istediğinizden emin misiniz?';
  ...
  @override
  String get loginRequiredMessage => 'Bu özelliğe erişmek için giriş yapmalısınız';

  @override
  String get loginToJoinMessage => 'Dünyanın dört bir yanındaki Müslümanlarla toplu hatmelere katılmak için giriş yapın';
  ...
  @override
  String get deleteConfirmationMessage => 'Bu hatmeyi silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.';
  ...
  String alreadyReservedPart(String part) {
    return 'Zaten rezerve edilmiş bir cüzünüz var ($part. cüz)';
  }
  ...
  String reservedForUser(String user) {
    return '$user için rezerve edildi';
  }
  ...
  @override
  String get quranRecitationsDesc => 'Ünlü okuyuculardan Kuran tilavetlerini dinleyin';
  ...
  @override
  String get reciterPremiumOnly => '🔒 Bu okuyucu sadece premium aboneler içindir';
  ...
  @override
  String get deleteAudioConfirm => 'Bu sesi silmek istediğinizden emin misiniz?';
  ...
  @override
  String get ramadanMubarakFull => 'Ramazan Mübarek, Allah onu bize ve size bereket ve rahmetle geri getirsin';
  ...
  @override
  String get locationPermissionDeniedForeverTitle => 'Konum izni kalıcı olarak reddedildi, izin isteyemiyoruz.';
  ...
  @override
  String get errorConvertingHijriDate => 'Hicri tarihi Miladi\\\'ye dönüştürme hatası';
  ...
  @override
  String get openInBrowserDescription => 'Canlı yayın, cihazın harici tarayıcısında açılacak';
  ...
  String copyrightNotice(String channel) {
    return 'Yayın, YouTube platformunda Yayıncılık ve Televizyon Kurumu\\\'na bağlı $channel kanalından yayınlanmaktadır. Uygulama herhangi bir içeriği yayınlamaz, depolamaz veya yeniden yayınlamaz ve tüm hakları sahiplerine aittir.';
  }

  @override
  String get copyrightRights => '© Tüm hakları saklıdır - İki Kutsal Caminin İşleri Genel Başkanlığı';
  ...
  @override
  String get premiumFeatureDescription => 'Bu özellik sadece premium aboneler için mevcuttur.\\nTüm özelliklerden yararlanmak için yükseltin!';
  ...
  String selectMuezzin(String muezzinName) {
    return 'Müezzin Seçin: $muezzinName';
  }
  ...
  String muezzinSelected(String muezzinName) {
    return 'Müezzin seçildi: $muezzinName';
  }
  ...
  String playingMuezzinSound(String muezzinName) {
    return 'Müezzin sesi çalınıyor: $muezzinName';
  }
  ...
  String languageUpdateError(String error) {
    return 'Dil güncellenirken hata: $error';
  }
  ...
  @override
  String get licensedBroadcast => 'Bu yayın resmi Suudi kanallarından lisanslanmıştır';
  ...
  @override
  String get khatmaTrackingNote => 'Hatime takibi sadece \"Yatay Çevirme\" modunda çalışır';
  ...
  @override
  String get pleaseWaitForMosquesToLoad => 'Lütfen camilerin yüklenmesini bekleyin';
  ...
  @override
  String get forgotPasswordDescription => 'E-posta adresinizi girin, size şifrenizi sıfırlamanız için bir bağlantı göndereceğiz';
  ...
  @override
  String get checkSpamMessage => 'Not: E-posta Spam klasörüne gidebilir, lütfen kontrol edin';

  @override
  String get copyrightHadithNotice => 'Tüm hakları kaynağa aittir. (HadeethEnc.com)';
  ...
  @override
  String get appDescription => 'İbadet ve İslami bilgi için kapsamlı uygulamanız';
  ...
  @override
  String get appFullDescription => 'Mishkat Al-Hoda Pro, dünya çapındaki Müslümanlar için ibadet ve İslami bilgiyi kolaylaştırmayı amaçlayan kapsamlı bir İslami uygulamadır.';

  @override
  String get intellectualRights => 'Fikri Mülkiyet Hakları';

  @override
  String get copyProhibition => '• İzin almadan içeriği kopyalamak veya dağıtmak yasaktır';

  @override
  String get contentSource => '• Güvenilir kaynaklardan İslami içerik';

  @override
  String get designProtection => '• Uygulama tasarımı ve programlama telif hakkı ile korunmaktadır';
  ...
  @override
  String get locationDataCollect => '• Doğru namaz vakitleri sağlamak için konum verisi topluyoruz';

  @override
  String get accountDataStorage => '• Hesap verileri yedekleme için güvenli bir şekilde saklanır';

  @override
  String get noDataSharing => '• Kişisel verilerinizi üçüncü taraflarla paylaşmıyoruz';

  @override
  String get guestData => 'Misafir Verisi';

  @override
  String get guestUsage => '• Uygulama kayıt olmadan misafir olarak kullanılabilir';

  @override
  String get localStorage => '• Misafir verisi yalnızca cihazınızda yerel olarak saklanır';

  @override
  String get accountConversion => '• İstediğiniz zaman kayıtlı hesaba dönüştürebilirsiniz';

  @override
  String get security => 'Güvenlik';

  @override
  String get sslEncryption => '• Tüm iletişimler için SSL şifrelemesi kullanıyoruz';
  ...
  @override
  String get worshipUsage => '• Uygulamayı ibadet ve İslami bilgi amaçları için kullanın';

  @override
  String get respectIntellectualProperty => '• İçeriğin fikri mülkiyet haklarına saygı gösterin';
  ...
  @override
  String get illegalUsageProhibition => '• Uygulamanın yasadışı amaçlar için kullanımına izin verilmez';

  @override
  String get copyModifyProhibition => '• İzin almadan içeriği kopyalamak veya değiştirmek yasaktır';
  ...
  @override
  String get welcomeQuestions => 'Uygulama hakkındaki soru ve taleplerinizi memnuniyetle karşılıyoruz';
  ...
  @override
  String get hadithsDescription => 'Açıklama ve sınıflandırma ile sahih hadisler koleksiyonu';
  ...
  @override
  String get allahNamesDescription => 'Anlamları ve faziletleri ile Allah\\\'ın Güzel İsimlerini öğrenin';
  ...
  @override
  String get broadcastDescription => 'Mekke\\\'deki Mescid-i Haram\\\'dan canlı yayın izleyin';
  ...
  @override
  String get dateConverterDescription => 'Hicri ve Miladi tarihler arasında dönüştürme';
  ...
  @override
  String get areYouSureDeleteAccount => 'Hesabınızı silmek istediğinizden emin misiniz?';
  ...
  @override
  String get needNewAccountToUseApp => 'Uygulamayı kullanmak için yeni bir hesap oluşturmanız gerekecek';
  ...
  @override
  String get deleteAccountAndAssociatedData => 'Hesabınızı ve ilişkili verileri silin';
  ...
  @override
  String get umrahRituals => 'Umre Ritüelleri';

  @override
  String get hajjRituals => 'Hac Ritüelleri';

  @override
  String get stepsLabel => 'Adımlar';

  @override
  String get supplicationsLabel => 'Dualar';

  @override
  String get stageCompletedLabel => 'Aşama Tamamlandı';

  @override
  String get islamicCalendar => 'İslami Takvim';

  @override
  String get hijriCalendar => 'Hicri';

  @override
  String get gregorianCalendar => 'Miladi';

  @override
  String get islamicEvents => 'İslami Günler';

  @override
  String get eventRamadanStart => 'Ramazan Başlangıcı';
  ...
  @override
  String get eventHajj => 'Hac';

  @override
  String get eventEidAlAdha => 'Kurban Bayramı';

  @override
  String get eventAlHijra => 'Hicri Yılbaşı';

  @override
  String get eventAshura => 'Aşure Günü';

  @override
  String get eventMawlidAlNabi => 'Mevlid Kandili';

  @override
  String get eventLaylatAlMiraj => 'Miraç Kandili';

  @override
  String get eventLaylatAlBaraat => 'Berat Kandili';
